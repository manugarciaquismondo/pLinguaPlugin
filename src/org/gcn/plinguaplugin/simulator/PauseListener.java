...
/**
 * This class causes the simulator of the {@link SimulatorDisplayer} instance the button belongs to to pause the current simulation
 * @author Manuel Garcia-Quismondo-Fernandez
 *
 */
class PauseListener extends ButtonSelectionListener{

	/**
	 * Creates a new {@link ResetListener} instance which causes the simulator of the {@link SimulatorDisplayer} given as argument to pause the current simulation
