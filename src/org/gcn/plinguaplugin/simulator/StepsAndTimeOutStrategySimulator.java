 ...
 *
 */
class StepsAndTimeOutStrategySimulator extends StrategySimulator {

	private int steps;
	private long timeOut;
	
	/**
	 * Creates a new {@link StepsAndTimeOutStrategySimulator} instance which runs the {@link SimulatorDisplayer} instance simulator limiting both the number of steps and the time out
	...
	public void run() throws PlinguaCoreException {
		SimulatorController.runUntilTimeOutorSteps(getSimulator(), timeOut, steps);
