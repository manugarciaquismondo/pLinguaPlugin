...
/**
 * This class checks if the text within a text field defines a number greater than 0. The format number should be Long Integer.
 * @author Manuel Garcia-Quismondo-Fernandez
 *
 */
class CheckTimeOutTextListener extends CheckNumberTextListener {

	/**
	 * Creates a new {@link CheckTimeOutTextListener} instance which test a text field
	 ...
	 */
	public CheckTimeOutTextListener(SimulatorDisplayer simulatorDisplayer,
	...
	protected boolean checkSpecificType(String arg0) {
		...
		try{
			return Float.parseFloat(arg0)>0;
		}
