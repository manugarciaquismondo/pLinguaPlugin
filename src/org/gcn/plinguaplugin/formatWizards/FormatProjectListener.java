...
/**
 * This class checks if the project indicated by the project field text field exists and updates its {@link WizardPage} instance wizard project field
 * @author Manuel Garcia-Quismondo-Fernandez
 *
 */
public class FormatProjectListener extends AbstractProjectListener {
	/**
	 * Creates a new {@link FormatProjectListener} instance which contains the project text field given as parameter
	 ...
	 */
	public FormatProjectListener(WizardPage paramPage, Text textField) {
	...
	protected void setProject(String project, boolean change) {
		((InputFormatWizard)(getParamPage().getWizard())).setProject(project, change);
